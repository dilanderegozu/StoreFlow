...
namespace StoreFlow.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult CreateProduct()
        {
            ...
            return View();
            //SelectListItem, ASP.NET MVC'de dropdown listelerinde kullanılan özel bir sınıf. İki alan dolduruluyor:
            //Value → c.CategoryId.ToString() : Kategorinin ID'si, string'e çevriliyor (dropdown'da gönderilecek değer)
           // Text → c.CategoryName : Kategorinin adı(kullanıcının ekranda göreceği metin)
        }
        ...
        //ilk 4 kaydı atla sonraki 10 kaydı getir
